...
export default class LineManager {
  ...
  static setLineManagerInputEvent = ({ target }) => {
    if (target.id === "line-add-button") {
      const startStation =
        DOMS.$startStation.options[DOMS.$startStation.selectedIndex].value;
      const endStation =
        DOMS.$endStation.options[DOMS.$endStation.selectedIndex].value;
      const lineName = DOMS.$lineManagerInput.value;
